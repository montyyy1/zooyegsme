  ...
  async execute(message, args) {
    try {
      ...
      let embed1 = new MessageEmbed()
        .setColor("#FFB901")
        .setDescription(`❌ Mention someone to money`);
      ...
      let embed2 = new MessageEmbed()
        .setColor("#FFB901")
        .setDescription(`❌ You cannot money yourself`);
      ...
      let embed3 = new MessageEmbed()
        .setColor("#FFB901")
        .setDescription(`❌ Specify an amount to money`);
      ...
      let embed6 = new MessageEmbed()
        .setColor("#FFB901")
        .setDescription(
          `✅ You add Money ${user.displayName} ${args[1]} coins`
        );
